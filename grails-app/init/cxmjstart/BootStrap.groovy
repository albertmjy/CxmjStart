...
//                def t2 = new TeaBasicInfo(name: "2017陈升号霸王青饼", brand: "陈升号", year: "2017", category: "生普", region: "拼配", unitLabel: u1).save()
//                def t3 = new TeaBasicInfo(name: "2014益木堂景迈", brand: "益木堂", year: "2014", category: "生普", region: "普洱", county:"2", village: "milk", committee: "B啊", unitLabel: u1).save()
...
//
//                def t4_1 = new TeaBasicInfo(name: "2008年临沧茶厂保山茶砖", brand: "临沧茶厂", year: "2008", category: "生普", region: "保山", county:"", village: "", committee: "", unitLabel: u1).save()
//
//                def t5 = new TeaBasicInfo(name: "2014年同兴号刮风寨", brand: "同兴号", year: "2014", category: "生普", region: "勐腊", county:"勐腊县", village: "刮风寨自然村", committee: "麻黑村委会", unitLabel: u1).save()
//
//                def t6 = new TeaBasicInfo(name: "2015年同兴号刮风寨", brand: "同兴号", year: "2015", category: "生普", region: "勐腊", county:"勐腊县", village: "刮风寨自然村", committee: "麻黑村委会", unitLabel: u1).save()
//                def t7 = new TeaBasicInfo(name: "2016年同兴号刮风寨", brand: "同兴号", year: "2016", category: "生普", region: "勐腊", county:"勐腊县", village: "刮风寨自然村", committee: "麻黑村委会", unitLabel: u1).save()
//
//
//                new GeoInfo(city: "shanghai", ss: "aa", year: 1999, age: 20).save()
//
